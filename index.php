    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="form-inline my-2 my-lg-0">
            ...
            <button class="btn btn-outline my-2 my-sm-0" id="sign-in" type="sign">Sign in</button>
          </form>
        </div>
      </nav>
    </div>
...
<div class="row">
  ...
  <div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
    ...
    <div class="card-body">
      ...
      <a href="#"><h5 class="main-title">Azure fundamentals</h5></a>
  ...
  <div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
    ...
    <div class="card-body">
      ...
      <a href="#"><h5 class="main-title">Get started building with Power BI</h5></a>
  ...
  <div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
    ...
    <div class="card-body">
      <h6 class="card-title">MODULE</h6>
      <a href="#"><h5 class="main-title">What is Microsoft 365?</h5></a>
...
<div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
  ...
  <div class="card-body">
    <h6 class="card-title">MODULE</h6>
    <a href="#"><h5 class="main-title">Choose a data storage approach in Azure</h5></a>
...
<div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
  ...
  <div class="card-body">
    <h6 class="card-title">MODULE</h6>
    <a href="#"><h5 class="main-title">Introduction to Power Platform</h5></a>
...
<div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
  ...
  <div class="card-body">
    <h6 class="card-title">MODULE</h6>
    <a href="#"><h5 class="main-title">Introduction to Azure virtual machines</h5></a>
...
<div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
  ...
  <div class="card-body">
    <h6 class="card-title">MODULE</h6>
    <a href="#"><h5 class="main-title">Get started with Power Apps</h5></a>
...
<div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
  ...
  <div class="card-body">
    <h6 class="card-title">MODULE</h6>
    <a href="#"><h5 class="main-title">Secure your Azure Storage account</h5></a>
...
<div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
  ...
  <div class="card-body">
    <h6 class="card-title">MODULE</h6>
    <a href="#"><h5 class="main-title">Discover data analysis</h5></a>
...
<a href="#"><p class="learning">See what others are learning ></p></a>
<div class="container">
...
<div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
  ...
  <div id="card-body-favorite" class="card-body">
    ...
    <a href="#"><h5 class="main-title">Introduction to the Microsoft Azure Well-Architected Framework</h5></a>
...
<div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
  ...
  <div class="card-body">
    ...
    <h6 class="card-title-favorite">MODULE</h6>
    <a href="#"><h5 class="main-title">Create and publish a static web app with Gatsby and Azure Static Web Apps</h5></a>
...
<div class="cards col-sm-12 col-md-8 col-lg-3 ms-depth-8">
  ...
  <div class="card-body">
    ...
    <h6 class="card-title-favorite">MODULE</h6>
    <a href="#"><h5 class="main-title">Automate development tasks by using GitHub Actions</h5></a>
